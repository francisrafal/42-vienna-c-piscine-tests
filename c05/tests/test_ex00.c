...
/*   Updated: 2022/08/22 13:28:44 by frafal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	printf_title("ex00/ft_iterative_factorial.c");
	int n; 

	n = 0;
	printf_testresult(ft_iterative_factorial(n) == 1);
	printf("\n");
	...
	n = 4;
	printf_testresult(ft_iterative_factorial(n) == 24);
	printf("\n");
	...
	n = -3;
	printf_testresult(ft_iterative_factorial(n) == 0);
	printf("\n");
